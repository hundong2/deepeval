...
- Repository URL: https://github.com/hundong2/deepeval.git
- Checkout SHA: 655c1c42f8718c0d838316ac932f0bfed3475370
- README file: README_kor.md
- Evidence file: README_kor.md
- README title: Windows PowerShell
- Dependency markers: Python
- Top-level directories: .claude-plugin, .cursor-plugin, .deepeval, .scripts, .vscode, assets, deepeval
- Category: Evaluation, security, observability

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for deepeval.
